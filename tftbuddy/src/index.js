...
import iconAP from './etc/tft-assets/ap.png';
import iconAD from './etc/tft-assets/atk.png';
import iconAR from './etc/tft-assets/armor.png';
import iconMR from './etc/tft-assets/mr.png';
import iconAS from './etc/tft-assets/atkspd.png';
import iconRange from './etc/tft-assets/range.png';
import iconCrit from './etc/tft-assets/crit.png';
...
function open_champion_info(num) {
    ...
    let champ_ad = document.createElement("img");
    let champ_ap = document.createElement("img");
    let champ_ar = document.createElement("img");
    let champ_mr = document.createElement("img");
    let champ_crit = document.createElement("img");
    let champ_crit_mult = document.createElement("img");
    let champ_atkspd = document.createElement("img");
    let champ_range = document.createElement("img");
    champ_ad.src = iconAD;
    champ_ap.src = iconAP;
    champ_ar.src = iconAR;
    champ_mr.src = iconMR;
    champ_crit.src = iconCrit;
    champ_crit_mult.src = iconCrit;
    champ_range.src = iconRange;
    champ_atkspd.src = iconAS;
    ...
    let stat_atkspd = document.createElement("p");
    let stat_range = document.createElement("p");
    let stat_hp = document.createElement("p");
    let stat_mana = document.createElement("p");
    ...
    stat_range.innerHTML = "660";
    stat_atkspd.innerHTML = ".80";
    stat_hp.innerHTML = "900";
    stat_mana.innerHTML = "75";
    let stat_columnL1 = document.createElement("div");
    let stat_columnL2 = document.createElement("div");
    stat_columnL1.appendChild(champ_ad);
    stat_columnL2.appendChild(champ_ap);
    stat_columnL1.appendChild(champ_ar);
    stat_columnL2.appendChild(champ_mr);
    stat_columnL1.appendChild(champ_atkspd);
    stat_columnL2.appendChild(champ_range);
    stat_columnL1.appendChild(champ_crit);
    stat_columnL2.appendChild(champ_crit_mult);
    stat_columnL1.id = "modal-colL1";
    stat_columnL2.id = "modal-colL2";
    let stat_columnR1 = document.createElement("div");
    let stat_columnR2 = document.createElement("div");
    stat_columnR1.appendChild(stat_ad);
    stat_columnR2.appendChild(stat_ap);
    stat_columnR1.appendChild(stat_ar);
    stat_columnR2.appendChild(stat_mr);
    stat_columnR1.appendChild(stat_atkspd);
    stat_columnR2.appendChild(stat_range);
    stat_columnR1.appendChild(stat_crit);
    stat_columnR2.appendChild(stat_crit_mult);
    let hp_mana_container = document.createElement("div");
    hp_mana_container.id = "hp-mana-container";
    hp_mana_container.appendChild(stat_hp);
    hp_mana_container.appendChild(stat_mana);

    stat_columnR1.id = "modal-colR1";
    stat_columnR2.id = "modal-colR2";
    ...
    champ_info.appendChild(stat_columnL1);
    champ_info.appendChild(stat_columnR1);
    champ_info.appendChild(stat_columnL2);
    champ_info.appendChild(stat_columnR2);
    ...
    champ_info.appendChild(hp_mana_container);
